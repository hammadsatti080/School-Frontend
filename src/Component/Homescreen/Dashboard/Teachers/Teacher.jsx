...
import PrintTeachers from "./PrintTeachers";
const Teacher = () => {
...
const [confirmDelete, setConfirmDelete] = useState(null); // store teacher to delete
  ...
  const fetchTeachers = async () => {
    const res = await fetch("https://school-backend-blond.vercel.app/api/teachers");
...
const validate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingTeacher) {
        await fetch(`https://school-backend-blond.vercel.app/api/teachers/${editingTeacher._id}`, {
          method: "PUT",
        ...
        await fetch("https://school-backend-blond.vercel.app/api/teachers", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(formData),
        });
  ...
  const handleDelete = async (id) => {
    await fetch(`https://school-backend-blond.vercel.app/api/teachers/${id}`, {
      method: "DELETE",
    });
...
/* */
 const filteredTeachers = teachers.filter((t) => {
  ...
  <PrintTeachers teachers={filteredTeachers} />
</div>
